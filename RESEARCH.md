...
Для проверки работоспособности архитектуры версии **Baseline** был проведен инференс в среде ONNX Runtime на контрольных изображениях. Ниже представлены результаты детекции:
